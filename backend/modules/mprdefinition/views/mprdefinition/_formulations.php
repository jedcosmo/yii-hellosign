...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
			...
			'footer'=>Formulation::fPercentageTotal($formuladataProvider->models,'formulation_percentage',$model->mpr_defination_id_pk),
        ],
		...
		[
            ...
            'value' => function($data){
			 ...
			 'footer'=>Formulation::kgWeightTotal($formuladataProvider->models,'weight_by_weight',$model->mpr_defination_id_pk),
        ],
