...
<div class="company-form">
	...
	<div class="row">
        ...
        <div class="form-group col-sm-8" >
            ...
            <a href="<?= \yii\helpers\Url::to(['/company/company']) ?>" class="text-primary" style="text-decoration:underline;">Cancel</a>
            <?php } else { ?>
...
$this->registerJsFile(Yii::$app->homeUrl.'js/company.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
?>
