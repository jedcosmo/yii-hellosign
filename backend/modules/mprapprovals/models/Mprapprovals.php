...
/**
 * This is the model class for table "bpr_mpr_approval".
 *
 * @property integer $mpr_approval_id_pk
 ...
 */
class Mprapprovals extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            'mpr_approval_id_pk' => 'Mpr Approval ID',
