...
<div class="mprapprovals-form">
    ...
    <input type="hidden" name="mpr_approval_id_pk" id="mpr_approval_id_pk" value="<?=$model->mpr_approval_id_pk;?>">
    ...
    <label class="col-sm-3">MPR Approver<span class="text-danger">&nbsp;*&nbsp;</span></label>
    <div class="col-sm-8">
    ...
    <?php }?>
  	...
  	<label class="col-sm-3">MPR Verifier<span class="text-danger">&nbsp;*&nbsp;</span></label>
    <div class="col-sm-8">
...
$this->registerJsFile(Yii::$app->homeUrl.'js/mprapprovals.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
?>
