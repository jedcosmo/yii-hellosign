		...
		jQuery("#gmp-personupdate-form").validate({
			...
			rules: {
				...
				gmp_emailid : { 
								...
								gmpemail: true,
								maxlength: 60,
								remote: SITEROOT+'myprofile/myprofile/emailunique?action=check_duplicate_email&edit_id=' + edit_id,
							},
				gmp_user_name_person : { 
										...
										maxlength: 16,
										gmpusername:true,
										remote: SITEROOT+'myprofile/myprofile/emailunique?action=check_duplicate_username&edit_id=' + edit_id,
									},
				gmp_password_person : { 
										minlength: 6,
										maxlength: 16,
			...
			/*submitHandler: function(form) { 
				$('#myprofilesubbtn').prop('disabled', true);
				form.submit();
			},*/
		});
