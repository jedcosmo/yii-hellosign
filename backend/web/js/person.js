jQuery(document).ready(function(){
		...
		jQuery("#gmp-person-form").validate({
			...
			rules: {
				...
				gmp_emailid : { 
								...
								maxlength: 60,
								remote: { 
									url : SITEROOT + "person/person/emailunique", 
									data : {"action" : "check_duplicate_email",'edit_id': edit_id},
									type : "post"
									//async:false
								}
							},
				gmp_user_name_person : { 
										...
										remote: { 
											url : SITEROOT + "person/person/emailunique", 
											data : {"action" : "check_duplicate_username",'edit_id': edit_id},
											type : "post"
											//async:false
										}
									},
		...
		jQuery("#gmp-personupdate-form").validate({
			...
			/*submitHandler: function(form) { 
				$('#personsubbtn').attr('disabled', 'disabled');
				form.submit();
			},*/
		});
